...
4. Worked example: auto-centering slope-intercept sampler.
...
- Each `modelValues` class comes from a configuration of what variables are needed (and their types ans sizes).
